<template>
    <el-dialog id="intersect-rule-dialog" :show-close="true" :visible="isOpenIntersectRuleEditDialog" @close="handleClose"
        v-loading="loading" element-loading-text="正在添加中" element-loading-spinner="el-icon-loading"
        element-loading-background="rgba(0, 0, 0, 0.8)" title="编辑交集规则">
                    ...
                    <div class="form-rule">
                                                ...
                                                <div class="cond-statements">
                                                    ...
                                                    <div
                                                        ...
                                                        <el-alert title="" type="info" :closable="false" :show-icon="false">
                                                            <template slot='title'>
                                                                <div v-for="(item, index) in intersectRuleAddForm.alarmRuleDTO.rules"
                                                                    :key="index" style="margin-top: 5px">
                                                                    <el-form-item label="参数种类" prop="alarmRuleDTO.rules">
                                                                        <el-select style="width: 200px"
                                                                            v-model="intersectRuleAddForm.alarmRuleDTO.rules[index]"
                                                                            placeholder="参数种类">
                                                                            <el-option v-for="item in rulesClass"
                                                                    ...
                                                                    <el-form-item label="参数详情"
                                                                        ...
                                                                        <div v-for="(item, index) in intersectRuleAddForm.alarmRuleDTO.jsonObject[parseInt(intersectRuleAddForm.alarmRuleDTO.rules[index]) - 1]"
                                                                            :key="index" style="margin-top: 5px"
                                                                            :class="index ? 'indent' : ''">
                                                                            ...
                                                                            <!--根据选项确定单位-->
                                                                            <span>{{ item.paramName === 'distance' ? '米' :
                                                                                '' }}</span>
                                                                            <span>{{ item.paramName === 'wild' ? '米' : ''
                                                                            }}</span>
                                                                            <span>{{ item.paramName ===
                                                                                'peopleNumberThreshold' ? '人' : '' }}</span>
                                                                            <span>{{ item.paramName === 'seconds' ? '秒' : ''
                                                                            }}</span>
                                                                            <span>{{ item.paramName === 'ch2o' ? 'ug/m³' :
                                                                                '' }}</span>
                                                                            <span>{{ item.paramName === 'tvoc' ? 'ug/m³' :
                                                                                '' }}</span>
                                                                            <span>{{ item.paramName === 'pm2d5' ? 'ug/m³' :
                                                                                '' }}</span>
                                                                            <span>{{ item.paramName === 'pm10' ? 'ug/m³' :
                                                                                '' }}</span>
                                                                        </div>
                                                                    </el-form-item>
                                        ...
                                        <div class="output">
                                            ...
                                            <div class="top_body">
                                                <div class="condition-type">
                                                    <el-form-item label="输出方式" prop="alarmRuleDTO.voiceId">
                                                        <el-select v-model="intersectRuleAddForm.alarmRuleDTO.voiceId"
                                                            placeholder="请选择">
                                                            <el-option v-for="item in alarmVoiceOptions" :key="item.id"
                                                                :label="item.ruleType" :value="item.id">
                                                            </el-option>
                                                        </el-select>
                                                    </el-form-item>
                                                    ...
                                                    <!-- <div class="type-radio">
                                                        <el-form-item label="报警方式" prop="alarmRuleDTO.alertType">
                                                            <el-radio-group
                                                                v-model="intersectRuleAddForm.alarmRuleDTO.alertType"
                                                                @change="changeType">
                        ...
                        <el-row>
                            <div class="form-alarm-time">
                                <el-card shadow="never" class="box-card">
                                    <div class="output">
                                        <div class="top_head">警戒时间范围</div>
                                        <div class="alarm-time_body">
                                            <el-row>

                                                <el-col :span="12">
                                                    <el-form-item label="时间类型" prop="alarmTime.dateType">
                                                        <el-radio v-model="intersectRuleAddForm.alarmTime.dateType"
                                                            label='0'>周末</el-radio>
                                                        <el-radio v-model="intersectRuleAddForm.alarmTime.dateType"
                                                ...
                                                <el-col :span="12">
                                                    <el-form-item label="报警日期" prop="alarmTime.intersectAlarmDate">
                                                        <el-date-picker
                                                            v-model="intersectRuleAddForm.alarmTime.intersectAlarmDate"
                                                ...
                                                <el-col :span="12">
                                                    <el-form-item label="报警时间" prop="alarmTime.intersectAlarmTime">
                                                        <el-time-picker
                                                            v-model="intersectRuleAddForm.alarmTime.intersectAlarmTime"
        ...
        <div slot="footer" class="dialog-footer">
            <el-button @click="isOpenIntersectRuleEditDialog = false">取 消</el-button>
...
import { updateAndRule, allVoices } from '@/api/rule/RuleConfig'

export default {
    name: 'IntersectRuleAddDialog',
    props: {
        isOpenIntersectRuleEditDialog: {
            type: Boolean,
            default: false
        },
    ...
    watch: {
        monitorGroupConfigFormData: {
            handler: function (newVal, oldVal) {
                // switch (newVal.alarmRuleDTO.alertType) {
                //     case 0:
                //         newVal.alarmRuleDTO.alertType = '站内通知'
                //         break
                //     case 1:
                //         newVal.alarmRuleDTO.alertType = '邮件通知'
                //         break
                //     case 2:
                //         newVal.alarmRuleDTO.alertType = '手机短信'
                //         break
                //     case 3:
                //         newVal.alarmRuleDTO.alertType = 'APP通知'
                //         break
                // }
                // switch (newVal.alarmRuleDTO.alertType) {
                //     case '站内通知':
                ...
                //         this.emailType = newVal.alarmRuleDTO.receiveEmails
                //         this.telphone = ''
                //         this.appUser = ''
                //         break
                //     case '手机短信':
                ...
                //         this.isAppDisabled = true
                //         this.telphone = newVal.alarmRuleDTO.receivePhoneNumbers
                //         this.emailType = ''
                //         this.appUser = ''
                //         break
                //     case 'App通知':
                ...
                //         this.telphone = newVal.alarmRuleDTO.receiveUsers
                //         this.emailType = ''
                //         this.telphone = ''
                //         break
                // }
                this.intersectRuleAddForm = newVal
                console.log("this.intersectRuleAddForm", this.intersectRuleAddForm);
            },
            deep: true
        }
    },
        ...
        submitForm(formName) {
            this.$refs[formName].validate((valid) => {
                if (valid) {
                    ...
                    //         break
                    // }
                    updateAndRule(this.intersectRuleAddForm).then((res) => {
                        if (res.code === 200) {
                            this.$message({
                                duration: 3000,
                                type: 'success',
    ...
    created() {
        ...
        this.intersectRuleAddForm = deepCopy(this.monitorGroupConfigFormData)
